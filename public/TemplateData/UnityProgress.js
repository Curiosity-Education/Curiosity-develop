function UnityProgress (dom) {
	...
	background.style.background = "#585d66";
    background.style.backgroundImage="url(TemplateData/bg.gif)";
    ...
    progressFrame.setAttribute("id","img-progress");
	...
	this.Update = function() {
		...
		this.progressFrame.style.top = this.dom.offsetTop + (this.dom.offsetHeight * 0.6 + logoImg.height * 0.1) + 'px';
		this.progressFrame.style.left = this.dom.offsetLeft + (this.dom.offsetWidth * 0.43 - progressFrameImg.width * 0.5) + 'px';
		this.progressFrame.width = progressFrameImg.width+150;
		...
		this.progressBar.width = (progressFrameImg.width+150) * Math.min(this.progress, 1);
