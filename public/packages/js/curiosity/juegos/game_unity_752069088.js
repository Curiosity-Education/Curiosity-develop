...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 46755906;
      var PACKAGE_UUID = '869dc80f-aa45-4534-b410-84a1a6724ea1';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 20316, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(20316, 31220, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(31220, 38308, 0, 0).open('GET', '/level0');
    new DataRequest(38308, 38329, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(38329, 38451, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(38451, 43726021, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(43726021, 45170181, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(45170181, 46667553, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(46667553, 46728281, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(46728281, 46755906, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
