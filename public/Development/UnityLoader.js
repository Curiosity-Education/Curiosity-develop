...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'figuras.data';
    var REMOTE_PACKAGE_BASE = 'figuras.data';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 20764, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(20764, 32340, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(32340, 57536, 0, 0).open('GET', '/level0');
    new DataRequest(57536, 65312, 0, 0).open('GET', '/level1');
    new DataRequest(65312, 65588, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(65588, 68869, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(68869, 32108167, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(32108167, 34881563, 0, 0).open('GET', '/sharedassets0.resource');
    new DataRequest(34881563, 50874173, 0, 0).open('GET', '/sharedassets1.assets');
    new DataRequest(50874173, 52727361, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(52727361, 54224733, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(54224733, 54285461, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(54285461, 54313086, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_figuras.data');
