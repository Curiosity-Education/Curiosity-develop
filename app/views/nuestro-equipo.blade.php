	...
	<div class="container">
		<div class="col-md-10 col-md-offset-1">
			<div class="introduccion">
				<p class="text-xs-center">Un joven y multidisciplinario equipo, que comparten la iniciativa de crear una equidad educativa de forma divertida. Comprometidos con esta gran tarea hacen de <i>Curiosity Educación</i>
					una posibilidad para cumplir con un aprendizaje de calidad con las nuevas tecnologías.
				</p>
		...
		<div class="col-md-12" id="content-integrantes">
			<div class="col-md-4 col-sm-6">
				...
				<div class="card">
					...
					<div class="view overlay hm-blue-strong hm-zoom ">
						<img src="/packages/images/landing/equipo-mentores/daniel-min.jpg" class="img-fluid img-rounded" alt="daniel seijas gonzalez">
						<a>
			...
			<div class="col-md-4 col-sm-6">
				...
				<div class="card">
					...
					<!--Card image-->
					<div class="view overlay hm-blue-strong hm-zoom ">
						<img src="/packages/images/landing/equipo-mentores/willy-min.jpg" class="img-fluid img-rounded" alt="wilvardo ramirez colunga">
						<a>
							<div class="mask flex-center">
			...
			<div class="col-md-4 col-sm-6">
				...
				<div class="card">
					...
					<!--Card image-->
					<div class="view overlay hm-blue-strong hm-zoom">
						<img src="/packages/images/landing/equipo-mentores/gerson-min.jpg" class="img-fluid img-rounded" alt="gerson efrain isaias rivera">
						<a>
							<div class="mask flex-center">
			...
			<div class="col-md-4 col-sm-6">
				...
				<div class="card">
					...
					<!--Card image-->
					<div class="view overlay hm-blue-strong hm-zoom">
						<img src="/packages/images/landing/equipo-mentores/roger-min.jpg" class="img-fluid img-rounded" alt="rogelio rafael jinestas garcia">
						<a>
							<div class="mask flex-center">
			...
			<div class="col-md-4 col-sm-6">
				...
				<div class="card">
					...
					<div class="view overlay hm-pink-strong hm-zoom">
						<img src="/packages/images/landing/equipo-mentores/vicky-min.jpg" class="img-fluid img-rounded" alt="ana victoria bazan">
						<a>
							<div class="mask flex-center">
			...
			<div class="col-md-4 col-sm-6">
				...
				<div class="card">
					...
					<!--Card image-->
					<div class="view overlay hm-blue-strong hm-zoom">
						<img src="/packages/images/landing/equipo-mentores/mau-min.jpg" class="img-fluid img-rounded" alt="mauricio martinez martinez">
						<a>
							<div class="mask flex-center">
								<p class="white-text text-xs-center" style="margin:5px 15px;">"Nunca digas no puedo"</p>
							</div>
						</a>
					</div>
					<!--/.Card image-->
			...
			<div class="col-md-4 col-sm-6">
				...
				<div class="card">
					...
					<!--Card image-->
					<div class="view overlay hm-blue-strong hm-zoom">
						<img src="/packages/images/landing/equipo-mentores/guada-min.jpg" class="img-fluid img-rounded" alt="josé guadarrama">
						<a>
							<div class="mask flex-center">
			...
			<div class="col-md-4 col-sm-6">
				...
				<div class="card">
					...
					<!--Card image-->
					<div class="view overlay hm-blue-strong hm-zoom">
						<img src="/packages/images/landing/equipo-mentores/fernando-min.jpeg" class="img-fluid img-rounded" alt="fernando emmanuel canales rivas">
						<a>
							<div class="mask flex-center">
			...
			<div class="col-md-4 col-sm-6">
				...
				<div class="card">
					...
					<!--Card image-->
					<div class="view overlay hm-blue-strong hm-zoom">
						<img src="/packages/images/landing/equipo-mentores/inge-min.jpg" class="img-fluid img-rounded" alt="luis fernando garcia velazquez">
						<a>
							<div class="mask flex-center">
								<p class="white-text text-xs-center">"Una vida sin riesgos no es vida"</p>
							</div>
						</a>
					</div>
					<!--/.Card image-->
			...
			<div class="col-md-4 col-sm-6">
				...
				<div class="card">
					...
					<div class="card-block">
						<!--Title-->
						<h4 class="card-title text-xs-center">Nirvana Ferniza </h4>
						<hr>
						<!--Text-->
						<p class="card-text text-xs-center"><b>Área de desarrollo de juegos</b><br>Desarrolladora de juegos.</p>
					</div>
					<!--/.Card content-->
			...
			<div class="col-md-4 col-sm-6">
				...
				<div class="card">
					...
					<!--Card image-->
					<div class="view overlay hm-blue-strong hm-zoom">
						<img src="/packages/images/landing/equipo-mentores/jonhy-min.jpg" class="img-fluid img-rounded" alt="jonathan de la torre">
						<a>
							<div class="mask flex-center">
			...
			<div class="col-md-4 col-sm-6">
				...
				<div class="card">
					...
					<!--Card image-->
					<div class="view overlay hm-pink-strong hm-zoom">
						<img src="/packages/images/landing/equipo-mentores/sahian-min.jpg" class="img-fluid img-rounded" alt="sahian muro">
						<a>
							<div class="mask flex-center">
					...
					<div class="card-share">
						<div class="social-reveal">
							...
							<a type="button" class="btn-floating btn-tw"><i class="fa fa-twitter"></i></a>-->
							<!--Google -->
							<a type="button" class="btn-floating btn-email" href="mailto:fernando.canales@curiosity.com.mx"><i class="fa fa-envelope"></i></a>
						</div>
						<a class="btn-floating btn-action share-toggle primary-color-dark"><i class="fa fa-share-alt"></i></a>
					</div>
					<!--/Social buttons-->
