		...
		<div class="col-md-12" id="content-integrantes">
			<div class="col-md-4 col-sm-6">
				...
				<div class="card">
					...
					<div class="view overlay hm-zoom ">
						<img src="/packages/images/landing/equipo-mentores/carlos-min.jpg" class="img-fluid img-rounded" alt="carlos lira">
						<a>
			...
			<div class="col-md-4 col-sm-6" hidden="hidden">
				...
				<div class="card">
					...
					<!--Card image-->
					<div class="view overlay hm-zoom ">
						<img src="/packages/images/landing/equipo-mentores/eleazar-min.jpg" class="img-fluid img-rounded" alt="eleazar ortiz">
						<a>
							<!--<div class="mask flex-center">
								<p class="white-text">"La fuerza sea contigo"</p>
							</div>-->
			...
			<div class="col-md-4 col-sm-6">
				...
				<div class="card">
					...
					<!--Card image-->
					<div class="view overlay hm-zoom ">
						<img src="/packages/images/landing/equipo-mentores/gurza-min.jpg" class="img-fluid img-rounded" alt="antonio gurza">
						<a>
							<!--<div class="mask flex-center">
								<p class="white-text">"La fuerza sea contigo"</p>
							</div>-->
			...
			<div class="col-md-4 col-sm-6">
				...
				<div class="card">
					...
					<!--Card image-->
					<div class="view overlay hm-zoom ">
						<img src="/packages/images/landing/equipo-mentores/cristy-min.jpg" class="img-fluid img-rounded" alt="cristy Belausteguigoitia">
						<a>
							<!--<div class="mask flex-center">
								<p class="white-text">"La fuerza sea contigo"</p>
							</div>-->
			...
			<div class="col-md-4 col-sm-6" hidden="hidden">
				...
				<div class="card">
					...
					<!--Card image-->
					<div class="view overlay hm-zoom ">
						<img src="/packages/images/landing/equipo-mentores/neto-min.jpg" class="img-fluid img-rounded" alt="ernesto gutierres">
						<a>
							<!--<div class="mask flex-center">
								<p class="white-text">"La fuerza sea contigo"</p>
							</div>-->
			...
			<div class="col-md-4 col-sm-6">
				...
				<div class="card">
					...
					<!--Card image-->
					<div class="view overlay hm-zoom ">
						<img src="/packages/images/landing/equipo-mentores/nat-min.jpg" class="img-fluid img-rounded" alt="natalia ramirez">
						<a>
							<!--<div class="mask flex-center">
								<p class="white-text">"La fuerza sea contigo"</p>
							</div>-->
